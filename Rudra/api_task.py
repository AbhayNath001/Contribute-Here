...
def ApiExecution(tag,query):
    if "asteroid_count" in tag:
        ...
        try:
            ...
            if magnitudes:
                print(f"The brightest asteroid was {min_asteroid_name} with absolute magnitude of: {min_magnitude}")
                print(f"The most dimmed asteroid was {max_asteroid_name} with absolute magnitude of: {max_magnitude}")
            else:
